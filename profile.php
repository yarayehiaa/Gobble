...
session_start();
 ...
 if(isset($_SESSION['userid'])){
    ...
    $_SESSION['loc']=$row['State'].", ".$row['Country'] ;
    $_SESSION['rel'] =$row['RelationshipStatus'];
    $_SESSION['work'] =$row['job'];
    ...
    $_SESSION["reviews"]=$row['reviews'];
    $_SESSION["5star"]=$row['5stars'];
    ...
    <div class="page d-flex" style="flex-direction:column ;">
        ...
        <div style="margin:40px; ">
            <div class="card mx-auto" style="height: fit-content; transform: translate(120px,-350px); width: 80%;">
                <div class="card-body">
                    <pre><h2> &nbsp;  <?php echo $_SESSION['reviews']; ?>  &nbsp;  &nbsp;   <?php echo $_SESSION['friends']; ?>   &nbsp; &nbsp;    <?php echo $_SESSION['5star']; ?> </h2></pre>
                    ...
                    <p style="font-size:50px; font-style:oblique; text-align:center; margin-top: 5%; margin-bottom:5%"><?php echo $_SESSION['name']; ?></p>
                    <div style="margin-left: 00px ; text-align: center;">
                        <p> <i class="fa fa-location-arrow"> </i> <?php echo $_SESSION['loc']; ?></p>
                        <p> <i class="fa fa-heart-o"> </i> <?php echo $_SESSION['rel']; ?></p>
                        <p> <i class="fa fa-desktop"> </i> Works at <?php echo $_SESSION['work']; ?></p>
                        <p><i class="fa fa-book"> </i> Studied at <?php echo $_SESSION['edu']; ?></p>
                    </div>
                    <div style="margin: 40px;">
                    ...
                    <div class='latest-post' style='width:100%'>
                        ...
                        <div class='coment-area' style='width:100%'>
                            ...
                            <div class='post-comment' style='width:100%'>
                                <div class='comet-avatar'>
                                    <img src='$avatar' class='avatar' style='height:50px ;'>
                                </div>
    ...
    <div class="chatbox-message-wrapper">
        <div class="chatbox-message-header">
            <div class="chatbox-message-profile">
                <img src="WhatsApp Image 2022-11-18 at 7.31.51 PM.jpeg" alt="" class="chatbox-message-image">
                <div>
                    <h4 class="chatbox-message-name">Aisha Moghazy</h4>
