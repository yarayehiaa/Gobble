...
if(isset($_POST['btn'])) {
    ...
    $sql = "INSERT INTO `userdata`(`Fname`, `Lname`, `phone`, `bday`, `RelationshipStatus`,
     `Education`, `job`, `Country`, `State`, `Bio`, `img`,`email`)
      VALUES ('$fname','$lname','$phone','$bday','$rel',
      '$edu','$job','$country','$state','$bio','$img','$email')";
         
         if ($conn->query($sql) === TRUE) {
            if (move_uploaded_file($tempname, $folder)) {
                $_SESSION['name'] = $fname. " ".$lname;
                $_SESSION['loc'] = $state.", ". $country;
                $_SESSION['rel'] = $rel;
                $_SESSION['work'] = $job;
                $_SESSION['edu'] = $edu;
                $_SESSION["bio"]=$bio;
                ...
                $_SESSION["reviews"]=0;
                $_SESSION["5star"]=0;
                $sql2="select userid from userdata where email='$email'";
                $result2 = mysqli_query($conn,$sql2);
                $row2 = mysqli_fetch_array($result2,MYSQLI_ASSOC);
                $id=$row2['userid'];
                $_SESSION['userid']=$id;
                $sql3="insert into social (userid) values ($id)";
...
<body style="background-color: darkorange; overflow-x: hidden;">
                ...
                <div class="flex-container" id="title"
                    ...
                    <div style="transform:translate(10%,10%);">
                        <ul style="list-style: none; align-items: center; padding-left:3%; display: flex;">  
                            ...
                            <div>
                                <a href="Profile.html" style="right: auto;">
                                    <img src="Avatars Set Flat Style-16.png" style="height:35px ; width: 35px; ">
                                  </a>
                                </div>
    ...
    <div class="sidebar bg-white p-20 "
        ...
        <ul style="text-decoration:none; align-items: center; margin-top: -5px;">
            <li>
                <a class=" active d-flex align-center fs-14 c-black rad-6 p-10" href="edit profile.html">
                    <i class="fa fa-info fa-2x"></i>
                    <span>General Details</span>
                </a>
            </li>
            <li>
                <a class=" d-flex align-center fs-14 c-black rad-6 p-10" href="Social Links.html">
                    <i class="fa fa-link fa-2x"></i>
                    <span>Social Links</span>
                </a>
            </li>
            <li>
                <a class="d-flex align-center fs-14 c-black rad-6 p-10" href="Password.html">
                ...
                <?php 
                    ...
                    <div class="col-md-4 border-right">
                        <div class="d-flex flex-column align-items-center text-center p-3 py-5"> 
                            <img 
                                class="rounded-circle border-2 mt-5" width="150px"  src="Avatars Set Flat Style-16.png" id="image-preview"><span
                                class="font-weight-bold fs-25"><?php echo $_SESSION['login_user']; ?></span> <br>
                                <h5 style="color: coral;">Change Profile Picture</h5>
                                <form method="POST" enctype="multipart/form-data">
                                <input style="background-color: coral; border-color:coral; width: fit-content; " type="file" name="img" class="form-control" accept="image/*" name="image" onchange="updatePreview(this, 'image-preview')">
                                </input>
                                <br>
                                ...
                                class="form-control" type="text" style="height: 100px; width: 300px;" name="bio" maxlength="200"></textarea>
                    ...
                    <div class="col-md-6 border-right">
                        <div class="p-3 py-5">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h4 class="text-right" style="color: #777;">Create your profile</h4>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6"><label class="labels"> First Name</label>
                                <input type="text" 
                                        class="form-control" placeholder="First name" value="<?php echo $_SESSION['name']; ?>"></div>
                                <div class="col-md-6"><label class="labels">Last name</label>
                                <input type="text" name="lastn"
                                        class="form-control" value="" placeholder="Last name" required></div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-12"><label class="labels">Mobile Number</label>
                                <input type="number" name="phone"
                                        class="form-control" placeholder="Phone Number" value="" required></div>
                                ...
                                <input type="text" name="edu"
                                        class="form-control" placeholder="Education" value="" required></div>
                                <div class="col-md-12"><label class="labels">Work</label>
                                <input type="text" name="job"
                                        class="form-control" placeholder="job" value="" required></div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-6"><label class="labels">Country</label>
                                <input type="text" name="country"
                                        class="form-control" placeholder="country" value="" required></div>
                                <div class="col-md-6"><label class="labels">State/Region</label>
                                <input type="text" name="state"
                                        class="form-control" value="" placeholder="state" required></div>
                            </div>
                            <div class="mt-5 text-center">
                                <button style="background-color: coral;border-color: coral;" type="submit" name='btn'
                                    class="btn btn-primary btn-block mb-3" onclick="alert('Profile Saved!')">Save Profile</button>
